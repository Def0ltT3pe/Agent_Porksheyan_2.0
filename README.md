...
> Система распределённого мониторинга и выполнения задач с использованием агентов, REST API и опциональной очереди Redis.
...
| Компонент | Описание |
|----------|--------|
| FastAPI сервер | REST API и логика управления |
